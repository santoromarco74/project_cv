...
momento da `results/runs.csv`. Il risultato è `relazione/Relazione_finale.md`, che è il
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--out", default=os.path.join("relazione", "Relazione_finale.md"))
