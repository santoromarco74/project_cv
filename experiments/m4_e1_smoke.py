...
def figura(img_a, img_b, st, pts_a, pts_b, out_path, titolo, seed=42, quanti=80):
    ...
    print(f"figura: {out_path} ({len(idx)} corrispondenze disegnate su {len(inlier)} inlier)")
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--quanti", type=int, default=80, help="corrispondenze disegnate nella figura")
